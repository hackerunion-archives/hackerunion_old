...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HackerProfile.preferred_contact_email'
        db.add_column('people_hackerprofile', 'preferred_contact_email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'HackerProfile.preferred_contact_email'
        db.delete_column('people_hackerprofile', 'preferred_contact_email')
